const Header = () => {
  return (
    <header className="mb-2 px-4 shadow bg-[#FBEBB5]">
      <div className="relative mx-auto flex max-w-screen-lg flex-col py-4 sm:flex-row sm:items-center sm:justify-between">
        <a className="flex items-center text-2xl font-black" href="/">
          <span className="mr-2 text-3xl text-amber-950">
            <svg
        ...
        >
          <ul className="flex flex-col gap-y-4 sm:flex-row sm:gap-x-8">
            <li className="">
              <a className="text-gray-600 hover:text-[#4f772d]" href="/home">
                Home
              </a>
            </li>
            <li className="">
              <a className="text-gray-600 hover:text-[#4f772d]" href="/shop">
                Shop
              </a>
            </li>
            <li className="">
              <a className="text-gray-600 hover:text-[#4f772d]" href="/about">
                About
              </a>
            </li>
            <li className="">
              <a className="text-gray-600 hover:text-[#4f772d]" href="/contact">
                Contact
              </a>
            </li>
            <li className="mt-2 sm:mt-0">
              <a
                className="rounded-xl border-2 border-[#4f772d] px-6 py-2 font-medium text-[#4f772d] hover:bg-[#4f772d] hover:text-white"
                href="/logIn"
              >
                Login
              </a>
